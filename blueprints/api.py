...
from utils.security import api_permission_required
import json
...
@jwt_required()
@api_permission_required('can_view_employees')
def get_employees():
    """
...
@jwt_required()
@api_permission_required('can_view_own_profile')
...
@jwt_required()
@api_permission_required('can_add_employee')
def create_employee():
    """Create new employee."""
    data = request.get_json() or {}
    try:
...
@jwt_required()
@api_permission_required('can_edit_employee')
...
@jwt_required()
@api_permission_required('can_delete_employee')
...
@jwt_required()
@api_permission_required('can_view_departments')
def get_departments():
...
@jwt_required()
@api_permission_required('can_add_department')
...
@jwt_required()
@api_permission_required('can_delete_department')
...
@jwt_required()
@api_permission_required('can_view_own_attendance')
def get_attendance():
...
@jwt_required()
@api_permission_required('can_manage_attendance')
def mark_attendance():
...
@jwt_required()
@api_permission_required('can_view_own_leaves')
def get_leaves():
    """Get leave requests."""
    try:
...
@jwt_required()
@api_permission_required('can_approve_leave')
